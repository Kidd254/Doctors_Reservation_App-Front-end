...
import { deleteDoctor, fetchDoctors } from '../../redux/reducers/doctorsSlice';
  ...
  const confirmDelete = () => {
    if (doctorToDelete) {
      dispatch(deleteDoctor(doctorToDelete))
        ...
        .catch(() => {
          setMessage('This doctor has reservations. Please remove them first and try again.');
          setShowMessage(true);
        });
    }
    setOpenDialog(false);
