...
const AddDoctorForm = () => {
  ...
  const images2 = [
    ...
    { value: 'Doctor9.png', label: 'Doctor9', image: '/assets/Doctor9.png' },
    { value: 'Doctor10.png', label: 'Doctor10', image: '/assets/Doctor10.png' },
    { value: 'Doctor11.png', label: 'Doctor11', image: '/assets/Doctor11.png' },
    { value: 'Doctor12.png', label: 'Doctor12', image: '/assets/Doctor12.png' },
    { value: 'Doctor13.png', label: 'Doctor13', image: '/assets/Doctor13.png' },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await doctorRequests.addDoctor({ doctor: data });
